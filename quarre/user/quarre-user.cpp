...
static const std::vector<pdata_t> g_user_tree =
{
    ...
    { "/modules/vare/resonator/pitch_p", ossia::val_type::FLOAT, false },
    ...
    { "/modules/vare/body/sustain", ossia::val_type::FLOAT, false },
    { "/modules/vare/granular/pitch", ossia::val_type::FLOAT, false },
    { "/modules/vare/granular/overlap", ossia::val_type::FLOAT, false },
    { "/modules/vare/granular/rate", ossia::val_type::FLOAT, false },
    { "/modules/vare/granular/x", ossia::val_type::FLOAT, false },
    { "/modules/vare/granular/x_p", ossia::val_type::FLOAT, false },
    { "/modules/vare/gate/decay", ossia::val_type::FLOAT, false },
    { "/modules/vare/gate/leak", ossia::val_type::FLOAT, false },
